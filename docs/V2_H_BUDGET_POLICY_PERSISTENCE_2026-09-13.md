...
- current branch head `47a59d60ac315191843470647fb86baaaa2f5622` with CI #640 PASS;
...
`BUDGET_POLICY_PERSISTENCE_CORS_FIXED / CI_640_PASS / LOCAL_RUNTIME_ONLY / EXECUTION_STILL_LOCKED / WINDOWS_PERSISTENCE_RETEST_NEXT`
